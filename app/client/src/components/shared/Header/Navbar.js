        ...
        <div className="full-nav">
          ...
          <nav className="nav-links">
            {user && (
              <>
                ...
                <Link to="#">Sell content</Link>
                  ...
                  <span className="giatto-user">{user.user.username}</span>
            ...
            <div className="links">
              ...
              <Link className="signup-btn" to="/signup/socials">
                Signup
              </Link>
          ...
          >
            <ul>
              ...
              <li>
                <Link
                  to="/login/socials"
                  className="mobile-nav--links login-btn--mobile"
                >
                  Login
                </Link>
              </li>
              <li>
                <Link
                  to="/signup/socials"
                  className="mobile-nav--links signup-btn--mobile"
                >
                  Signup
                </Link>
              </li>
